...
function startExtension(context) {
    ...
    const intervalInSeconds = config.get('reminderInterval', 1200);
...
function showSettingsPanel(context) {
    ...
    reminderPanel = vscode.window.createWebviewPanel('blinkBuddySettings', '1Minute Break Settings', vscode.ViewColumn.Two, {
        enableScripts: true,
        retainContextWhenHidden: true
    });
    reminderPanel.webview.html = getSettingsHtml();
    reminderPanel.webview.onDidReceiveMessage(message => {
...
function showReminderModal(context) {
    if (reminderPanel) {
        reminderPanel.dispose();
    }
    reminderPanel = vscode.window.createWebviewPanel('blinkBuddyReminder', '1Minute Break Reminder', vscode.ViewColumn.Two, {
        enableScripts: true,
        retainContextWhenHidden: true
    });
